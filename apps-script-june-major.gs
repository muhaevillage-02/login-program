// ============================================================
//  LOGIN LAB — 나에게 딱 맞는 전공테스트 (june-major.html)
//  시트명: 전공테스트 신청자
// ============================================================
//
...
//  6. 배포 후 뜨는 웹 앱 URL 복사 → june-major.html 의 CONFIG.SUBMIT_ENDPOINT 값에 붙여넣기
// ============================================================
...
function doGet() {
  return ContentService
    .createTextOutput('나에게 딱 맞는 전공테스트 엔드포인트 정상 동작 중.')
