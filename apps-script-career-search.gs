// ============================================================
//  LOGIN LAB — 2026 대학생 진로 탐색 지원사업 신청서 (career-search.html)
//  시트명: 2026 대학생 진로 탐색 지원사업
// ============================================================
//
  ...
  try {
    ...
    if (sheet.getLastRow() === 0) {
      var headers = [
        ...
        '학교 · 학년', '전공',
        '고민 유형', '고민이 시작된 상황', '구체적으로 힘든 점', '지원 항목(1택)',
        '개인정보 동의',
        'User-Agent', '타임스탬프'
      ];
...
function doGet() {
  return ContentService
    .createTextOutput('2026 대학생 진로 탐색 지원사업 신청서 엔드포인트 정상 동작 중.')
